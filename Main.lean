...
-- K closure under P
theorem P_preserves_K1 (f : ValueFn) (hf : InCone f) :
...
theorem P_preserves_K2 (f : ValueFn) (hf : InCone f) :
...
theorem P_preserves_K3 (f : ValueFn) (hf : InCone f) :
    ∀ (y : Fin 2) (x : ℕ),
...
theorem P_preserves_K4 (f : ValueFn) (hf : InCone f) :
    ∀ (y : Fin 2) (x : ℕ),
...
theorem P_preserves_K5 (f : ValueFn) (hf : InCone f) :
...
theorem P_preserves_K6 (f : ValueFn) (hf : InCone f) :
...
theorem P_preserves_K7 (f : ValueFn) (hf : InCone f) :
